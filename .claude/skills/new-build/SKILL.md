...
- **README refresh every 5 releases** (owner rule). The last refresh was **1.0.19**. If this build's version is at
  least 5 above the last refresh (next due: **1.0.24**), rewrite `README.md` in the same commit so it matches the app,
